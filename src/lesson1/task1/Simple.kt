 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((((( deg * 60) + min) * 60) + sec) * PI) / (180 * 3600)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * sqr( 1 + (percent * 1.00 / 100)) * (1 + (percent * 1.00 / 100))
